...
function todosIguales(arreglo) {
  ...
  //Escribe tu código aquí  
  function todosI(arreglo){
     return arreglo.every(e => arreglo[0] === e)
  }

  return todosI(arreglo);
...
function mesesDelAño(array) {
  ...
  for(let i = 0 ; i < array.length ; i++){
    ...
    if(array[i] === "Enero" ){
      ...
      mesArray.push("Noviembre");
    }
  }

  if(mesArray.includes("Enero") && mesArray.includes("Marzo") && mesArray.includes("Noviembre")){
